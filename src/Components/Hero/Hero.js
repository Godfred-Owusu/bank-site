...
<div className='hero-container flex items-center justify-between gap-4 paddings'>
        <div className='w-full'>
           <h1 className='text-6xl font-medium hero-text'>Easy way to <br /> save your Money <br />with <span className='bank-name'><span className='font-semibold'>Atom</span>Bank.</span></h1>
           <p className='py-10 font-light text-sm'>The best place to transact and save money. We make all payment easier and simplier. Receive and send payment funds without cash</p>
            <div className='flex items-center justify-start'>
                 <div>
                    <button className='primary-btn'>Download Now</button>
